...
insert into DOACAO (ID, CONTACT_EMAIL, DESCRIPTION, IS_DISPONIVEL, LOCATION, PHOTO, POSTED_ON, TITLE, USER_ID ) values (2, 'junior@gmail.com', 'Cama de solteiro em ferro, cor de rosa, bom estado! Mando entregar', true, 'POA/RS', null, sysdate, 'Dou cama de solteiro novinha!', 8);
