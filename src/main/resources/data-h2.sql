...
--DOACAO
insert into DOACAO (ID, CONTACT_EMAIL, DESCRIPTION, IS_DISPONIVEL, LOCATION, PHOTO, POSTED_ON, TITLE, USER_ID ) values (1, 'ana@bol.com', 'Roupeiro com 3 anos de uso em MDF, que se interessar deve marcar uma data para buscar, pois não posso arcar com frete', true, 'Canoas/RS', null, sysdate, 'Roupeiro em ótimo estado de conservação', 3);
insert into DOACAO (ID, CONTACT_EMAIL, DESCRIPTION, IS_DISPONIVEL, LOCATION, PHOTO, POSTED_ON, TITLE, USER_ID ) values (2, 'junior@gmail.com', 'Cama de solteiro em ferro, cor de rosa, bom estado! Mando entregar', true, 'POA/RS', null, sysdate, 'Doo cama de solteiro novinha!', 8);
insert into DOACAO (ID, CONTACT_EMAIL, DESCRIPTION, IS_DISPONIVEL, LOCATION, PHOTO, POSTED_ON, TITLE, USER_ID ) values (3, 'lucas@bol.com', 'Bombacha tamanho 44, Camisa branca nº 3, Lenço de seda na cor vermelha e botas em couro, nº 44, cor preta', true, 'Caxias/RS', null, sysdate, 'Pilcha completa em ótimo estado', 6);
insert into DOACAO (ID, CONTACT_EMAIL, DESCRIPTION, IS_DISPONIVEL, LOCATION, PHOTO, POSTED_ON, TITLE, USER_ID ) values (4, 'marco@outlook.com', 'Mesa de madeira com tampo de vidro, Cadeiras com estofado, o tecido encontra-se levemente desbotado, mas tem como trocar e fica novinho! - Frete por conta do novo dono!', true, 'Santa Catarina/RS', null, sysdate, 'Mesa com 4 cadeiras', 4);